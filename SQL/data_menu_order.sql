...
CREATE TABLE `menu_order` (
  ...
  `od_place` varchar(45) DEFAULT NULL,
  `od_menuList` varchar(45) DEFAULT NULL,
  `od_cost` varchar(45) DEFAULT NULL,
  `od_payment` varchar(45) DEFAULT NULL,
  `od_mag` varchar(999) DEFAULT NULL,
  `od_orderDate` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`od_idx`)
